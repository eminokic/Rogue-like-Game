...
{
  /* Currently assumes that monsters only move on floors.  */
  ...
  d->pc_distance[character_get_y((character *) d->PC)]
                [character_get_x((character *) d->PC)] = 0;
...
void dijkstra_tunnel(dungeon_t *d)
{
  ...
  d->pc_tunnel[character_get_y((character *) d->PC)]
              [character_get_x((character *) d->PC)] = 0;
